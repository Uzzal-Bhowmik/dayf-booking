...
export default function ShowHotelProfileModal({ open, setOpen, hotelProfile }) {
    ...
    >
      ...
      <section className="space-y-2">
        <div className="mb-5 space-y-1">
          ...
          <p>{hotelProfile.shortDescription}</p>
        </div>
      ...
      <section className="mt-5 space-y-8">
        <ContentWrapper
          ...
          content={hotelProfile.description}
        />
        ...
        <section>
          ...
          <div className="flex-center-start flex-wrap gap-5">
            {hotelProfile.features.map((feature) => (
              <div
                key={feature.title}
        ...
        <section>
          ...
          <div className="grid max-w-[80%] grid-cols-4 gap-5">
            {hotelProfile.extraFeatures.map((feature, idx) => (
              <p
                key={idx}
